...
public partial class admin_Default : System.Web.UI.Page
{
    ...
    protected void AddServiceProvider()
    {
        try
        {
            string ImagePath = "";
         ...
         /*  if (TextBox4.Text.ToString() == TextBox5.Text.ToString())
                throw new Exception("Password or Confirm Password Must be Same");*/
                ...
                if (FileUpload1.HasFile)
                {
                    ...
                    if (file_size > 100)
                    {
                        /* FileUpload1.SaveAs(Server.MapPath("~/images/") + FileUpload1.FileName);
                         file_name = "~/images/" + FileUpload1.FileName;*/
           ...
           string password = enc.EncryptPlainTextToCipherText(TextBox4.Text.Trim(), TextBox2.Text.Trim());
            ...
            string sql_query = "insert into service_provider(name, email_id, mobile_no, password, gender, date_time, country_id, state_id, district_id, city_id, locality_id, pincode_id, status, image_path) values(@name, @email_id, @mobile_no,@password, @gender, @time_date, @country_id, @state_id, @district_id, @city_id, @locality_id, @pincode_id, @status, @image_path)";
            SqlCommand cmd = new SqlCommand(sql_query, con);
