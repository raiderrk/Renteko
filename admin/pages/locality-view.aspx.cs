...
public partial class admin_Default : System.Web.UI.Page
{
    ...
    protected void ddCountrylocality_SelectedIndexChanged(object sender, EventArgs e)
    {
    ...
    protected void ddstatelocality_SelectedIndexChanged(object sender, EventArgs e)
    {
    ...
    protected void dddistrictlocality_SelectedIndexChanged(object sender, EventArgs e)
    {
        DATABindCityDropdown();
    }

    protected void DATABindCityDropdown()
    {
        try
        {
            if (con.State != ConnectionState.Open)
            ...
            string sql_query = "select * from city where district_id = @district and status = 1";
            SqlCommand cmd = new SqlCommand(sql_query, con);
            ...
            else
            {
                ...
                ddcity.DataTextField = "city_name";
                ddcity.DataBind();
                ddcity.Items.Insert(0, "City not found");
            }
    ...
    protected void ddcitylocality_SelectedIndexChanged(object sender, EventArgs e)
    {
        LocalityDataBind();
    }
    protected void LocalityDataBind()
    {
        try
        {
            ...
            string sql_query = "select * from locality where city_id = @city and status = @status";
            SqlCommand cmd = new SqlCommand(sql_query, con);
            ...
            else
            {
                GridView1.DataSource = dt;
                GridView1.DataBind();
                Label1.Text = "Locality not found";
            }
        }
        catch (Exception ex)
        {
