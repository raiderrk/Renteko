<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="user-list.aspx.cs" Inherits="admin_Default" %>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="align-middle">
                        <a href="./user-view-details.aspx" class="text-primary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          View
                        </a>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-danger">Deactivate</span>
                      </td>
                      <td class="align-middle text-center">
